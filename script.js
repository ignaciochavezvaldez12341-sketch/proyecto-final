...
// Variables del DOM para el CRUD de Proyectos
...
// Función de seguridad (Protege la ruta #home)
const checkAccess = () => {
...
// --- LÓGICA DEL PANEL DE PROYECTOS (CRUD) ---

// CREATE: Mostrar/Ocultar formulario
if (addProjectBtn) {
...
// READ: Cargar Proyectos (GET /projects)
...
// CREATE/UPDATE: Manejo del formulario (POST /projects o PUT /projects/:projectId)
if (projectForm) {
...
// UPDATE: Precarga de datos al hacer click en Actualizar
...
// DELETE: Eliminar Proyecto (DELETE /projects/:projectId)
...
// Adjuntar Listeners para los botones de CRUD en la lista
